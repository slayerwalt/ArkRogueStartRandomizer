...
export interface RogueThemeEntry {
  ...
  id: string;
  name: string;
  /** 主题主视觉图（KV，取自 PRTS 上的游戏剧情资源） */
  banner: string;
  /** 开局随机是否已开放；未开放的主题只展示横幅与占位提示 */
  available: boolean;
}

export const ROGUE_THEMES: RogueThemeEntry[] = [
  { id: 'rogue_1', name: '傀影与猩红孤钻', banner: rogue1, available: false },
  { id: 'rogue_2', name: '水月与深蓝之树', banner: rogue2, available: false },
  { id: 'rogue_3', name: '探索者的银凇止境', banner: rogue3, available: false },
  { id: 'rogue_4', name: '萨卡兹的无终奇语', banner: rogue4, available: false },
  { id: 'rogue_5', name: '岁的界园志异', banner: rogue5, available: false },
  { id: 'rogue_6', name: '沉沦者的黑流树海', banner: rogue6, available: true },
];
